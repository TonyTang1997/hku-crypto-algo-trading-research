...
## Overview
0.1 [What is a cryptocurrency?](<# 1. What is a cryptocurrency?>)
0.2	[What is trading?](<# 2. What is trading?>)
0.3	[Why trade cryptocurrency?](<## 3. Trading cryptocurrencies>)
0.4	[Algoritmic trading](<## 4. Algorithmic Trading>)
